...
//representa um retangulo para persistencia de dados
public class RetanguloJson {
    String nome;
    float[][] pontos;
    int[] cor;
    int esp;

    public RetanguloJson(){}

    public RetanguloJson(float x1, float y1, float x2, float y2, Color c, int esp){
